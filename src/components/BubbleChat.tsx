...
export default function BubbleChat({
  ...
  const { replyHandler, isReplying, replyMessage } = useInbox();
  ...
  const isReplyingClick = (name, message) => {
    console.log(message);
    replyHandler(true, name, message);
  };
            ...
            <div className="flex-col">
              {isReply && (
                <div className="flex justify-end">
                  <div
                    className={`min-w-[312px] max-w-[518px] flex-col p-[9px] rounded-[5px] mb-[7px] bg-[#F2F2F2] border-[1px] border-[#E0E0E0]`}
                  >
              ...
              <div className="flex justify-end">
                <div
                  className="mr-[5px] pt-[4px] cursor-pointer relative z-[999]"
                  ...
                  >
                    <div className="flex-col">
                      <div className="flex items-center pl-[18.39px] border-b-[1px] border-b-[#BDBDBD] h-[40px]">
                        <span className="font-regular text-[#2F80ED]">
                          Share
                        </span>
                      </div>
                      <div
                        className="flex items-center h-[40px]"
                        onClick={() => isReplyingClick(name, message)}
                      >
                        <span className="pl-[18.39px] font-regular text-[#2F80ED]">
                          Reply
                        </span>
                      </div>
                    </div>
                ...
                <div
                  className={`relative min-w-[312px] max-w-[518px] flex-col p-[9px] rounded-[5px]`}
        ...
        <div className="pb-[10px] flex justify-start">
          ...
          >
            ...
            >
              <div className="flex-col">
                <div className="flex items-center pl-[18.39px] border-b-[1px] border-b-[#BDBDBD] h-[40px]">
                  <span className="font-regular text-[#2F80ED]">Share</span>
                </div>
                <div
                  className="flex items-center h-[40px]"
                  onClick={() => isReplyingClick(name, message)}
